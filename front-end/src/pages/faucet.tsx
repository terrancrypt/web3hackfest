...
const dataAssets: DataAssets[] = [
  ...
  {
    img: "https://assets.coingecko.com/coins/images/325/small/Tether.png?1668148663",
    name: "Tether",
    symbol: "USDT",
    address: "352c156916b40A392DB6676006e68Ac3D86A4011",
    contractAbi: WETHabi,
  },
];
  ...
  return (
    <section className="text-center space-y-6">
      <div className="space-y-4">
        ...
        <p>
          You need Sepolia ETH to pay transaction fees in the protocol. Pick up
          at{" "}
          <a
